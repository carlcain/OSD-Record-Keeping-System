...
ALTER TABLE admin ADD CONSTRAINT FK_ADMIN_USER FOREIGN KEY (userID) REFERENCES users(userID);
...
INSERT INTO users (userID, username,userPassword, userRole) VALUES (1004, 'zen23', 'CRUZ', 'STUDENT');
